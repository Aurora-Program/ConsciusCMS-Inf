                ...
                <Modal show={show} onHide={()=>setShow(false)}>
                  <Modal.Header closeButton className="modern-modal-header">
                    <Modal.Title className="modern-modal-title">
                      ...
                      Edit {props.Schema.name}
                    </Modal.Title>
                  </Modal.Header>
                  <Modal.Body className="modern-modal-body">
                    <div className="field-editor-content">
                      {props.Schema.description && (
                        <div className="field-description mb-3">
                          <small className="text-muted">{props.Schema.description}</small>
                        </div>
                      )}
                      <FloatingLabel
                        controlId="floatingTextInput"
                      ...
                      >
                        <Form.Control 
                          ...
                          value={value.text} 
                          onChange={(e) => {
                            if (props.Schema.max >= e.target.value.length) { 
                              setValue({text:e.target.value})
                            }
                          }} 
                          maxLength={props.Schema.max}
                          className="modern-input"
                          placeholder={`Enter ${props.Schema.name.toLowerCase()}...`}
                        />
                      </FloatingLabel>
                      {props.Schema.note && (
                      ...
                      {props.Schema.max && (
                        <div className="character-count">
                          <small className="text-muted">
                            {value.text?.length || 0} / {props.Schema.max} characters
                          </small>
                        </div>
                      )}
                    </div>
                  ...
                  <Modal.Footer className="modern-modal-footer">
                    <div className="modal-footer-content">
                      <div className="footer-actions">
                        ...
                        <Button 
                          variant='primary' 
                          onClick={() => {updateField(); setShow(false)}}
                ...
                <Modal.Header closeButton className="modern-modal-header">
                  <Modal.Title className="modern-modal-title">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="me-2">
                      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" stroke="currentColor" strokeWidth="2"/>
                      <path d="M14 2v6h6" stroke="currentColor" strokeWidth="2"/>
                      <path d="M9 15l2 2 4-4" stroke="currentColor" strokeWidth="2"/>
                    </svg>
                    Rich Text Editor - {props.name}
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body className="modern-modal-body">
